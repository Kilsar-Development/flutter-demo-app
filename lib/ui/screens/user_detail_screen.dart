...
class _UserDetailScreenState extends State<UserDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('User Details'), backgroundColor: Theme.of(context).colorScheme.inversePrimary),
      body: _buildBody(),
    );
  }

  Widget _buildBody() {
    if (_isLoading) return const Center(key: Key('loading_indicator'), child: CircularProgressIndicator());
    if (_error != null) {
      return Center(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Error loading user details', style: Theme.of(context).textTheme.titleLarge),
    ...
    if (_user == null) return const Center(key: Key('empty_state'), child: Text('User not found'));
      ...
      child: Column(
        ...
        children: [
          ...
          if (_user!.address != null) ...[
            ...
            _buildSection(title: 'Address', children: [
              ...
              if (_user!.address!.geo != null) _buildInfoRow('Location', 'Lat: ${_user!.address!.geo!.lat}, Lng: ${_user!.address!.geo!.lng}'),
            ]),
          ],
          if (_user!.company != null) ...[
            const SizedBox(height: 24),
            _buildSection(title: 'Company', children: [
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(child: Text(value, key: Key('${label.toLowerCase().replaceAll(' ', '_')}_value'))),
        ],
      ),
    );
  }
